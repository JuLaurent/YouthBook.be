<?php
    ...
    $this->assign('description', 'YouthBook.be est un site d’actualité et de critiques communautaire sur la littérature jeunesse, où tout le contenu est rédigé par les membres.');
