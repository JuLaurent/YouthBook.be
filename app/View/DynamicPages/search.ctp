<?php
    ...
    $this->assign('title', 'Recherches ' . $search);
    $this->assign('description', 'Page des recherches sur ' . $search);

?>

<section>

    <div class='page-title'><h2 class='beta page-title__item'>Recherches : <?php echo $search ?></h2></div>
