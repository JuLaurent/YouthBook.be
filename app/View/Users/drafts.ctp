                    ...
                    <li class='recent-article__item'>
                        <a href='<?php echo $this->Html->url( array( 'controller'=>'articlePages', 'action'=>'view', 'slug1' => $draft['Article']['id'], 'slug2' => $draft['Article']['slug'], 'slug3' => '1' )) ?>' title='Aller à la page de l&apos;article <?php echo $draft['Article']['title'] ?>' class='link'>
                            <div class='recent-article recent-article--sheet'>
                                <div class='recent-article__title recent-article__title--sheet'><?php echo $draft['Article']['title'] ?></div>
                                <div class='recent-article__informations recent-article__informations--sheet clearfix'>
                                    <span class='recent-article__date'><?php echo $this->Time->format('d/m/Y', $draft['Article']['created']) ?></span>
