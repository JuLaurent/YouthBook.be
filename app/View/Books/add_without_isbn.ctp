...
<section>
    ...
    <div class='bloc bloc--padding'>
        ...
        <div class="form">
            ...
            <?php
                echo $this->Form->create('Book', array('enctype' => 'multipart/form-data', 'novalidate' => true));
                        ...
                        echo $this->Form->input('Saga', array('label' => 'Saga', 'multiple' => false, 'empty' => 'Aucune série', 'class' => 'form-select', 'data-placeholder' => 'Sélectionnez une saga'));
                        echo $this->Form->input('pages', array('label' => 'Nombre de pages', 'min' => '0', 'value' => $this->Session->read('book')['pageCount'], 'class' => 'input-number'));
                ...
                echo $this->Form->end(__('Ajouter le livre'));
            ?>
        </div>
    </div>
