<?php
    ...
    $this->assign('title', 'Ajouter une saga');
        ...
        <div class="form">
            ...
            <?php echo $this->Form->create('Saga', array('enctype' => 'multipart/form-data', 'novalidate' => true)); ?>
                <?php
                    ...
                    echo $this->Form->input('Book.Book', array('label' => 'Livre(s) associé(s)', 'multiple' => true, 'class' => 'form-select', 'data-placeholder' => 'Sélectionnez un ou plusieurs livres'));
